...
public class UpdateItem extends JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(61, 68, 61));
        ...
        jButton3.setBackground(new java.awt.Color(95, 100, 95));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (rCount != 0) {
            ...
            com.example.items_hub.BillItem.bRecord.clear();
            ...
            for (int i = 0; i < rCount; i++) {
                ...
                com.example.items_hub.BillItem.bRecord.add(bi);

                for (ItemRecord it : com.example.items_hub.AddItem.item) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {
        ...
        for (BillingItemRecord bir : com.example.items_hub.BillItem.bRecord) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        com.example.items_hub.BillItem bi = new com.example.items_hub.BillItem();
        bi.setVisible(true);
        setVisible(false);
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (a == JOptionPane.OK_OPTION) {
            ...
            for (BillingItemRecord br : com.example.items_hub.BillItem.bRecord) {
                if (br.getItemID() == iId) {
                    com.example.items_hub.BillItem.bRecord.remove(br);
                    break;
                }
            }
            totalBill();

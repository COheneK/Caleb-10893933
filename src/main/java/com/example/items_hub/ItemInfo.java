...
public class ItemInfo extends JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setBackground(new java.awt.Color(95, 100, 95));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            if (iid.isBlank() == false) {
                ...
                while (li <= hi) {
                    if (n[mi] == id) {
                        for (ItemRecord i : com.example.items_hub.AddItem.item) {
                            if (id == i.getItemId()) {
    ...
    public void addTable() {
        ...
        for (ItemRecord itm2 : com.example.items_hub.AddItem.item) {
